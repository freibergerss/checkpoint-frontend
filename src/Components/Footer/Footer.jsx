...
const Footer = () => {
  ...
  return (
    <footer className={`styles.footerWrapper ${theme=== 'light' ? 'navbar-light bg-light': 'navbar-dark bg-dark'}`}>
      <div>
        ...
        <div className={` ${styles.footer} ${theme === 'light' ? 'navbar-light bg-light': 'navbar-dark bg-dark'}`}>
          <div className="container">
            <div className={`row`}>
              ...
              <div className={`col-sm-12 col-lg-6 ${styles.icons} ${theme === 'light' ? styles.icons : styles.iconsDark}`}>
